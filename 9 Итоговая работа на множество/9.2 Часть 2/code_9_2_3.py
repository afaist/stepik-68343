...
На вход программе подается одна строка, содержащая числа – показания спутника
...
Примечание. Рассмотрим 1 тест: у нас подаются данные 10 20 30 10 40 10. Мы
видим, что число 10 содержится тут 3 раза – значит, повторяющиеся числа 10 надо
удалить. Таких у нас 2 (первое число 10 мы не учитываем). Другие числа не
повторяются, поэтому ответ будет 2.
"""
